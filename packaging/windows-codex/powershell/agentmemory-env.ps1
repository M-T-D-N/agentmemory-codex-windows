...
Get-RequiredFixedValue -Values $contract.fixed_environment -Name 'AGENTMEMORY_LOCAL_QWEN_MAX_OUTPUT_TOKENS' -Expected '32768'
Get-RequiredFixedValue -Values $contract.fixed_environment -Name 'AGENTMEMORY_LOCAL_QWEN_TIMEOUT_MS' -Expected '1200000'
