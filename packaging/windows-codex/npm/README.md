...
```powershell
npx --yes agentmemory-codex-windows@0.1.0-preview.4 --fresh --install-root "C:\AgentMemoryCodex" --workspace-root "D:\Work" --project-registry "D:\Work\projects.json"
```
...
`--archive "D:\Downloads\agentmemory-codex-windows-0.1.0-preview.4-win32-x64.zip"`
