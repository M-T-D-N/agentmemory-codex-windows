...
```powershell
npx --yes agentmemory-codex-windows@0.1.0-preview.5 --fresh --install-root "C:\AgentMemoryCodex" --workspace-root "D:\Work" --project-registry "D:\Work\projects.json"
```
...
`--archive "D:\Downloads\agentmemory-codex-windows-0.1.0-preview.5-win32-x64.zip"`
