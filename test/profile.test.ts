...
describe("Profile Function", () => {
  ...
  it("excludes internal Codex sessions and invalidates legacy cached profiles", async () => {
    await kv.set("mem:profiles", "my-project", {
      project: "my-project",
      updatedAt: new Date().toISOString(),
      topConcepts: [{ concept: "internal-marker", frequency: 99 }],
      topFiles: [],
      conventions: [],
      commonErrors: [],
      recentActivity: [],
      sessionCount: 99,
      totalObservations: 99,
    });
    ...
    await kv.set("mem:obs:ses_internal", "obs_internal", {
      id: "obs_internal",
      ...
      facts: [],
      narrative: "internal-marker",
      concepts: ["internal-marker"],
      files: ["/internal.ts"],
      importance: 10,
    });
