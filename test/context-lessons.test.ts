...
describe("mem::context — lessons auto-injection (#457)", () => {
  ...
  it("does not inject observations from internal Codex sessions", async () => {
    ...
    const visibleObservation: CompressedObservation = {
      id: "obs_visible",
      ...
      title: "visible-title",
      facts: [],
      narrative: "visible-context-marker",
      concepts: [],
      files: [],
      importance: 8,
    };
    ...
    await kv.set(KV.observations("ses_internal"), "obs_internal", {
      ...visibleObservation,
      id: "obs_internal",
      sessionId: "ses_internal",
      title: "internal-title",
      narrative: "internal-context-marker",
      importance: 10,
    });
