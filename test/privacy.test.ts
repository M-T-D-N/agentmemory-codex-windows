...
describe("stripPrivateData", () => {
  ...
  it("strips GitHub PATs", () => {
    expect(
      stripPrivateData("token: ghp_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghij"),
  ...
  it("preserves descriptive credential assignments that are not secret formats", () => {
    const input = "password=descriptive-not-a-secret-value";
