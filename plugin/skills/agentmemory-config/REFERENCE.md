...
Configuration is read from the environment and from `~/.agentmemory/.env` (no `export` prefix). 55 recognized variables:

- `AGENTMEMORY_AGENT_SCOPE`
- `AGENTMEMORY_ALLOW_AGENT_SDK`
- `AGENTMEMORY_AMBIENT_BLOCK`
- `AGENTMEMORY_AUTO_COMPRESS`
- `AGENTMEMORY_CODEX_SOURCE_ROOT`
...
- `AGENTMEMORY_DEBUG`
- `AGENTMEMORY_DIAGNOSTICS_FILE`
- `AGENTMEMORY_DIAGNOSTICS_RUN_ID`
...
- `AGENTMEMORY_LOCAL_QWEN_BASE_URL`
