...
```json
memory_smart_search { "project": "app", "query": "session caching decision", "limit": 10 }
```
...
```json
memory_smart_search { "project": "app", "query": "rate limiter", "limit": 10 }
```
...
```json
memory_smart_search { "project": "app", "query": "graphql schema migration", "limit": 10 }
```
