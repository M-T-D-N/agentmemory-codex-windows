...
// Match the iii-http and worker invocation contracts. Aborting the loopback
// fetch at 15s can tear down the worker WebSocket while a valid large-index
// operation is still running, unregistering the entire MCP surface.
