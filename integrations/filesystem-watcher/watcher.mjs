import { watch, promises as fsp, realpathSync, statSync } from "node:fs";
  ...
  start() {
    ...
    for (const root of this.roots) {
      try {
        ...
        // WHY: Windows can expose the temp directory as an 8.3 short path while
        // libuv reports file events with its long path, which aborts Node's
        // recursive watcher when the prefixes do not match.
