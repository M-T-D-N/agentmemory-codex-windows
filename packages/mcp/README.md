...
> [!IMPORTANT]
> This is upstream-compatibility source bundled in **AgentMemory for Codex on
> Windows**. The downstream repository marks this package private and does not
> publish it to npm. The managed Windows/Codex profile uses the operating guide
> at [`packaging/windows-codex/README.md`](../../packaging/windows-codex/README.md).
